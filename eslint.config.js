...
export default [
    {
        ignores: ['build/*.js', 'build/rolldown/**', 'staging/**', 'coverage/**', 'node_modules/**', 'docs/**', 'dist/**', 'site/**', 'eminence-planning-map/**', 'test/integration/bundler/*/**', '**/*_generated.js', '**/*_generated.mjs', 'test/bench/**/benchmarks_worker.mjs']
    },
    {
        ignores: ['test/bench/**'],
        files: ['**/*.ts', '**/*.js'],
